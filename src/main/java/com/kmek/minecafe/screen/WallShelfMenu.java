...
public class WallShelfMenu extends AbstractContainerMenu {
    ...
    private void add8Slots(IItemHandler handler, int startIndex, int startX, int startY) {
        for (int i = 0; i < 8; i++) {
    ...
    private static final int TE_INVENTORY_SLOT_COUNT = WallShelfBlockEntity.menuSlotCount;  // must be the number of slots you have!
